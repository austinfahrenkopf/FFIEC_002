...
try{window._inlineLbls=localStorage.getItem('ffiec002_inlinelbls')!=='0';const _cs=localStorage.getItem('ffiec002_chartsize');if(_cs){const _m=_cs.split('x');window._chartW=+_m[0]||0;window._chartH=+_m[1]||0;}}catch(_){}
